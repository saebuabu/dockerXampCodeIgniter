...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        $this->default['TrustServerCertificate'] = filter_var(env('database.default.trustServerCertificate', $this->default['TrustServerCertificate']), FILTER_VALIDATE_BOOLEAN);
